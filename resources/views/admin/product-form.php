...
$product = $isEdit ? [
  'id'=>1,'name'=>'Cashmere Blend Coat','slug'=>'cashmere-blend-coat',
  'price'=>389,'old_price'=>520,'category_id'=>1,'description'=>'A masterwork in refined tailoring.',
  'sku'=>'LC-OC-001','stock'=>8,'weight'=>1.2,'status'=>'active',
  'badge'=>'sale','featured'=>true,'sizes'=>'XS,S,M,L,XL','colors'=>'Camel,Black,Ivory',
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem">
  <a href="/admin/pages/products.php" class="btn btn-ghost btn-sm">← Back to Products</a>
  <?php if ($isEdit): ?>
  <a href="/pages/product.php?slug=<?= urlencode($product['slug']) ?>" target="_blank" class="btn btn-ghost btn-sm">View Live →</a>
  <?php endif; ?>
</div>

<form method="POST" action="/admin/pages/product-save.php" enctype="multipart/form-data">
  <?php if ($isEdit): ?>
  ...
  <div style="display:grid;grid-template-columns:1fr 320px;gap:1.5rem;align-items:start">
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:0.75rem">
        ...
        <a href="/admin/pages/products.php" class="btn btn-ghost btn-block">Cancel</a>
      </div>
    </div>
