<?php
/**
 * LUXE SHOP — Checkout Page
 */
// require_once __DIR__ . '/../includes/config.php';
// if (!isLoggedIn()) redirect('/auth/login.php?redirect=/cart/checkout.php');

$pageTitle  = 'Checkout — Luxe Shop';
$activePage = '';
...
<section class="section">
  <div class="container">
    <form method="POST" action="/cart/process-order.php" id="checkout-form">
            ...
            <div class="payment-methods">
              <label class="payment-option selected">
                ...
                <div class="payment-option-info">
                  ...
                  <small style="color:var(--text-muted)">Free on orders over $150, otherwise $9.99</small>
                </div>
              </label>
            ...
            <div id="card-fields" style="margin-top:1.5rem">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" name="card_expiry" class="form-control" placeholder="MM / YY" maxlength="7">
                </div>
                <div class="form-group">
                  <label>CVV</label>
                  <input type="text" name="card_cvv" class="form-control" placeholder="•••" maxlength="4">
                </div>
              </div>
              <div class="form-group">
