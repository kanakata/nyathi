...
// if (!isLoggedIn()) redirect('/auth/login.php?redirect=/pages/account.php');
  ...
  <div class="container">
    <div class="account-layout">
      ...
      <nav class="account-nav">
        ...
        <a href="/auth/logout.php" class="account-nav-item" style="margin-top:2rem;color:var(--danger)"><span class="icon">→</span> Sign Out</a>
      </nav>
      ...
      <div>
            ...
            <table class="orders-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="/pages/order-detail.php?id=<?= urlencode($order['id']) ?>" class="btn btn-ghost btn-sm">View</a></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
        ...
        <div id="profile" class="card" style="padding:2rem;margin-bottom:2rem">
          ...
          <form method="POST" action="/pages/update-profile.php">
            <div class="form-row">
