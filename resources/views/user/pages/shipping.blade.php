...
<div class="page-hero">
    <div class="container">
        ...
        <nav class="breadcrumb">
            <a href="/">Home</a><span class="breadcrumb-sep">›</span><span>Shipping & Returns</span>
        </nav>
    </div>
</div>
...
<section class="section">
    <div class="container" style="max-width:860px">
        ...
        <p style="line-height:1.9;margin-bottom:1rem">Orders placed before 2pm EAT on business days are dispatched the
            same day. Once shipped, you will receive a tracking link by email. We ship to over 50 countries worldwide;
            international duties and taxes may apply.</p>

        <hr style="border:none;border-top:1px solid var(--border);margin:3rem 0">

        <h2 style="margin-bottom:1rem">Returns & Exchanges</h2>
        <div class="divider left"></div>
        <p style="line-height:1.9;margin-bottom:1rem">We want you to love every item. If you are not completely
            satisfied, you may return eligible items within <strong style="color:var(--text)">30 days</strong> of
            delivery.</p>
        ...
        <ul style="display:flex;flex-direction:column;gap:0.5rem;padding-left:1.25rem;list-style:disc">
            <li style="color:var(--text-muted);font-size:0.9rem">Unworn and unwashed with all original tags attached
            </li>
        ...
        <ul style="display:flex;flex-direction:column;gap:0.5rem;padding-left:1.25rem;list-style:disc">
            <li style="color:var(--text-muted);font-size:0.9rem">Underwear, swimwear, and pierced jewellery (for hygiene
                reasons)</li>
        ...
        <ol style="display:flex;flex-direction:column;gap:0.75rem;padding-left:1.25rem">
            <li style="color:var(--text-muted);font-size:0.9rem">Log in to <a href="/account"
                    style="color:var(--gold)">My Account</a> and navigate to your order.</li>
            <li style="color:var(--text-muted);font-size:0.9rem">Select the item(s) you wish to return and choose a
                reason.</li>
            <li style="color:var(--text-muted);font-size:0.9rem">Download and print your prepaid return label.</li>
            <li style="color:var(--text-muted);font-size:0.9rem">Pack the items securely and drop off at any designated
                courier point.</li>
            <li style="color:var(--text-muted);font-size:0.9rem">Your refund will be processed within 3–5 business days
                of receipt.</li>
        </ol>

        <div style="margin-top:3rem;text-align:center">
            <a href="/contact" class="btn btn-outline">Questions? Contact Support</a>
        </div>
