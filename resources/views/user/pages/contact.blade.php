<?php
/**
 * LUXE SHOP — Contact Page
 */
$pageTitle  = 'Contact Us — Luxe Shop';
$activePage = 'contact';
        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem">
          <div class="feature-item" style="padding:0">
            ...
            <div class="feature-text">
              <h4>Email</h4>
              <a href="mailto:hello@luxeshop.com" style="color:var(--gold);font-size:0.85rem">hello@luxeshop.com</a>
            </div>
          </div>
          <div class="feature-item" style="padding:0">
            <div class="feature-icon">☎</div>
      ...
      <div class="card" style="padding:2.5rem">
        ...
        <form method="POST" action="/pages/contact-process.php">
          ...
          <div class="form-group">
            ...
            <input type="text" id="order_id" name="order_id" class="form-control" placeholder="e.g. LX-A4F1E2">
          </div>
          <div class="form-group">
            <label for="message">Message</label>
            <textarea id="message" name="message" class="form-control" rows="5"
                      data-maxlength="1000" required
