<?php
/**
 * LUXE SHOP — About Page
 */
$pageTitle  = 'About Us — Luxe Shop';
$activePage = 'about';
...
<section class="section">
  <div class="container" style="max-width:860px">
    <div class="section-header">
      ...
      <p style="font-size:1.05rem;line-height:1.9;max-width:680px;margin:0 auto">
        Luxe was founded on a simple belief: that beautiful, well-made clothing should be accessible
        without compromising on integrity. We source exclusively from ethical manufacturers
        and use sustainable materials wherever possible.
      </p>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:3rem;margin-top:4rem;align-items:center">
      <div>
        <div style="aspect-ratio:4/5;background:var(--surface-2);overflow:hidden">
          <img src="/assets/images/banners/about1.jpg" alt="Our atelier" style="width:100%;height:100%;object-fit:cover">
        </div>
      </div>
      <div>
        ...
        <p style="line-height:1.9;margin-bottom:1.5rem">
          Every garment in our collection is reviewed by our in-house style team before it reaches you.
          We work directly with artisan producers in Kenya, Italy, and Japan to ensure fair wages
          and exceptional quality.
        </p>
        <p style="line-height:1.9">
          Our packaging is 100% recyclable and our carbon footprint is offset through certified
          reforestation programmes in East Africa.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:2rem">
      ...
      <div style="text-align:center">
        <div style="width:120px;height:120px;border-radius:50%;background:var(--surface-2);margin:0 auto 1.25rem;border:2px solid var(--gold-dark)"></div>
        <h4 style="font-family:var(--font-display);font-size:1.1rem;margin-bottom:0.25rem"><?= e($member['name']) ?></h4>
